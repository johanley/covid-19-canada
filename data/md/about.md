...
The *table* form of the data links to supporting screen-shots (*csv* and *json* do not):
 ...
 |Hospitalizations|[table](https://github.com/johanley/covid-19-canada/blob/master/data/md/hosp.md)|[csv](https://github.com/johanley/covid-19-canada/blob/master/data/csv/tests.csv)|[json](https://github.com/johanley/covid-19-canada/blob/master/data/json/hosp.json) |
...
NS: Their terms are ambiguous. The NS press releases refer to the same number as being BOTH *positive test results* 
and *cases*. Their term *negative test results* can be taken as exactly that, as a count of tests.
...
QC, NL, and NU: these report **purely on numbers of people, not numbers of tests**. 
